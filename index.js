...
(async () => {
    try {
        ...
        const connection = await connectToDatabase(); 
        app.post('/companies',authorize, async (req, res) => {
        ...
        app.get('/companies', authorize, async (req, res) => {
            try{
        ...
        app.get('/companies/:id',authorize, async (req, res) => {
            try {
        ...
        app.patch('/companies/:id',authorize, async (req, res) => {
            try {
        ...
        app.delete('/companies/:id',authorize, async (req, res) => {
            try {
                const companyId = req.params.id; 
